...
import {
  ILoginInputDTO,
  ISignupInputDTO,
  ISignupAndLoginOutputDTO,
  User,
  USER_ROLES,
  IGetUsersInputDTO,
  IGetUserMapOutputDTO,
  IGetUsersOutputDTO,
  IDeleteUserInputDTO,
...
export class UserBusiness {
  public signup = async (
  ...
  ): Promise<ISignupAndLoginOutputDTO> => {
    ...
    const response: ISignupAndLoginOutputDTO = {
  ...
  public getUsers = async (
    input: IGetUsersInputDTO
  ): Promise<IGetUsersOutputDTO> => {
    ...
    const users = usersDB.map((userDB) => {
      ...
      const userResponse: IGetUserMapOutputDTO = {
        id: user.getId(),
        name: user.getName(),
        email: user.getEmail(),
      };
  ...
  public deleteUser = async (
    input: IDeleteUserInputDTO
  ): Promise<IDeleteUserOutputDTO> => {
    const token = input.token;
